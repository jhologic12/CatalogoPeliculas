package co.com.hss.peliculas.datos;

import co.com.hss.pelicula.domain.Pelicula;
import co.com.hss.peliculas.excepciones.*;
import java.io.*;
import java.io.File;
...
public class AccesoDatosImpl implements IAccesoDatos {
    ...
    public void escribir(Pelicula pelicula, String nombreRecurso, boolean anexar) throws EscrituraDatosEx {
        ...
        try {
            ...
            salida.close();
            System.out.println("Se ha escrito exitosamente informacion al archivo" + pelicula);
        } catch (IOException ex) {
            ex.printStackTrace(System.out);
